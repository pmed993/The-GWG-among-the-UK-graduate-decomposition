...
***** COLLINEARITY ****
*** wave 29
correl gor_dv racel_dv ptexp ptexp2 ftexp ftexp2 if wave ==29
correl gor_dv racel_dv ptexp ptexp2 ftexp ftexp2 jbsoc00_cc jbsic07 if wave == 29
*** wave 21
...
reg lngrswage dgor1-dgor12 dracel_dv1-dracel_dv18 ///
	ftexp ftexp2 ptexp ptexp2 if wave == 29 
predict resid, resid29
predict xb29, xb
summ lngrswage xb29 resid29 if wave ==29
 sc resid29 xb29, yline(0)

reg lngrswage dgor1-dgor12 dracel_dv1-dracel_dv18 ///
	ftexp ftexp2 ptexp ptexp2 if wave == 21

/// graph oaxaca
mat list e(b)

coefplot (., keep(*)),  bylabel("Explained") || ///
(., keep(unexplained:*)),  bylabel("Unexplained") || , ///
drop(Prediction_* Difference) recast(bar) barwidth(0.5) citop ciopts(recast(rcap) color(black)) ///
